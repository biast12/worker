...
var (
	...
	PermissionsTitle                  MessageId = "permissions.title"
	PermissionsHasAdministrator       MessageId = "permissions.has_admin"
	PermissionsHasAllPermissions      MessageId = "permissions.has_all_permissions"
	PermissionsMissing                MessageId = "permissions.missing"
	PermissionsViewChannel            MessageId = "permissions.view_channel"
	PermissionsManageChannels         MessageId = "permissions.manage_channels"
	PermissionsManageRoles            MessageId = "permissions.manage_roles"
	PermissionsManageWebhooks         MessageId = "permissions.manage_webhooks"
	PermissionsSendMessages           MessageId = "permissions.send_messages"
	PermissionsSendMessagesInThreads  MessageId = "permissions.send_messages_in_threads"
	PermissionsCreatePublicThreads    MessageId = "permissions.create_public_threads"
	PermissionsCreatePrivateThreads   MessageId = "permissions.create_private_threads"
	PermissionsEmbedLinks             MessageId = "permissions.embed_links"
	PermissionsAttachFiles            MessageId = "permissions.attach_files"
	PermissionsAddReactions           MessageId = "permissions.add_reactions"
	PermissionsUseExternalEmojis      MessageId = "permissions.use_external_emojis"
	PermissionsMentionEveryone        MessageId = "permissions.mention_everyone"
	PermissionsManageThreads          MessageId = "permissions.manage_threads"
	PermissionsReadMessageHistory     MessageId = "permissions.read_message_history"
	PermissionsUseApplicationCommands MessageId = "permissions.use_application_commands"
